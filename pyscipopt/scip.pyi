...
class PY_SCIP_HEURTIMING(IntEnum):
    ...
    AFTERLPLOOP: L[0x4]
    AFTERLPNODE: L[0x8]
    AFTERPSEUDONODE: L[0x10]
    AFTERLPPLUNGE: L[0x20]
    AFTERPSEUDOPLUNGE: L[0x40]
    DURINGPRICINGLOOP: L[0x80]
    BEFOREPRESOL: L[0x100]
...
class PY_SCIP_EVENTTYPE(IntEnum):
    ...
    UBRELAXED: L[0x400]
    GHOLEADDED: L[0x800]
    GHOLEREMOVED: L[0x1000]
    LHOLEADDED: L[0x2000]
    LHOLEREMOVED: L[0x4000]
    IMPLADDED: L[0x8000]
    PRESOLVEROUND: L[0x20000]
    NODEFOCUSED: L[0x40000]
    NODEFEASIBLE: L[0x80000]
    NODEINFEASIBLE: L[0x100000]
    NODEBRANCHED: L[0x200000]
    NODEDELETE: L[0x400000]
    FIRSTLPSOLVED: L[0x800000]
    LPSOLVED: L[0x1000000]
    LPEVENT: L[0x1800000]
    POORSOLFOUND: L[0x2000000]
    BESTSOLFOUND: L[0x4000000]
    ROWADDEDSEPA: L[0x8000000]
    ROWDELETEDSEPA: L[0x10000000]
    ROWADDEDLP: L[0x20000000]
    ROWDELETEDLP: L[0x40000000]
    ROWCOEFCHANGED: L[0x80000000]
    ROWCONSTCHANGED: L[0x100000000]  # noqa: PYI054
    ROWSIDECHANGED: L[0x200000000]  # noqa: PYI054
    SYNC: L[0x400000000]  # noqa: PYI054

    GBDCHANGED: L[0x60]
    LBCHANGED: L[0x180]
    UBCHANGED: L[0x600]
    BOUNDTIGHTENED: L[0x280]
    BOUNDRELAXED: L[0x500]
    BOUNDCHANGED: L[0x780]
    GHOLECHANGED: L[0x1800]
    LHOLECHANGED: L[0x6000]
    HOLECHANGED: L[0x7800]
    DOMCHANGED: L[0x7F80]
    VARCHANGED: L[0x1FFFE]
    VAREVENT: L[0x1FFFF]
    NODESOLVED: L[0x380000]
    NODEEVENT: L[0x3C0000]
    SOLFOUND: L[0x6000000]
    SOLEVENT: L[0x6000000]
