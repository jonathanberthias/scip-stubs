...
class ExprCons:
    ...
    @overload
    def __init__(
        self, /, expr: Expr | GenExpr, lhs: float, rhs: None = None
    ) -> None: ...
    @overload
    def __init__(
        self, /, expr: Expr | GenExpr, lhs: float | None, rhs: float
    ) -> None: ...
    def normalize(self, /) -> None: ...
...
class GenExpr:
    ...
    def __abs__(self, /) -> UnaryExpr: ...
    def __add__(self, other: Expr | float | GenExpr, /) -> SumExpr: ...
    def __mul__(self, other: Expr | float | GenExpr, /) -> ProdExpr: ...
    def __pow__(self, other: SupportsFloat, mod: Any = None, /) -> PowExpr: ...
    def __truediv__(self, other: Expr | float | GenExpr, /) -> ProdExpr: ...
    def __rtruediv__(self, other: float, /) -> ProdExpr: ...
    def __neg__(self, /) -> ProdExpr: ...
    def __sub__(self, other: Expr | float | GenExpr, /) -> SumExpr: ...
...
def exp(expr: Expr | SupportsFloat | GenExpr) -> UnaryExpr: ...
def log(expr: Expr | SupportsFloat | GenExpr) -> UnaryExpr: ...
def sqrt(expr: Expr | SupportsFloat | GenExpr) -> UnaryExpr: ...
def sin(expr: Expr | SupportsFloat | GenExpr) -> UnaryExpr: ...
def cos(expr: Expr | SupportsFloat | GenExpr) -> UnaryExpr: ...

_Node: TypeAlias = tuple[str, list[Variable | float]]

def expr_to_nodes(expr: GenExpr) -> list[_Node]: ...
def value_to_array(val: float, nodes: list[_Node]) -> int: ...
def expr_to_array(expr: GenExpr, nodes: list[Node]) -> int: ...
