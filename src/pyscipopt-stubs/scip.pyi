...
class PY_SCIP_EVENTTYPE(IntEnum):
    ...
    SOLFOUND = 0x6000000
    SOLEVENT = 0x6000000
    GAPUPDATED = 0x11000000
    ROWCHANGED = 0x380000000  # noqa: PYI054
    ROWEVENT = 0x3F8000000  # noqa: PYI054

class PY_SCIP_LOCKTYPE(IntEnum):
    MODEL = 0
    CONFLICT = 1

class PY_SCIP_IMPLINTTYPE(IntEnum):
    NONE = 0
    WEAK = 1
    STRONG = 2
...
class Variable(Expr):
    ...
    def getImplType(self) -> PY_SCIP_IMPLINTTYPE: ...
    def getIndex(self) -> int: ...
    def getLPSol(self) -> float: ...
    def getLbGlobal(self) -> float: ...
    def getLbLocal(self) -> float: ...
    def getLbOriginal(self) -> float: ...
    def getNBranchings(self, branchdir: PY_SCIP_BRANCHDIR) -> int: ...
    def getNBranchingsCurrentRun(self, branchdir: PY_SCIP_BRANCHDIR) -> int: ...
    def getNLocksDown(self) -> int: ...
    def getNLocksDownType(self, locktype: PY_SCIP_LOCKTYPE) -> int: ...
    def getNLocksUp(self) -> int: ...
    def getNLocksUpType(self, locktype: PY_SCIP_LOCKTYPE) -> int: ...
    ...
    def isImpliedIntegral(self) -> bool: ...
    def isInLP(self) -> bool: ...
    def isIntegral(self) -> bool: ...
    def isNonImpliedIntegral(self) -> bool: ...
    def isOriginal(self) -> bool: ...
    def isRelaxationOnly(self) -> bool: ...
    def markRelaxationOnly(self) -> None: ...
    @property
    def name(self) -> str: ...
    def ptr(self) -> int: ...
...
class Constraint:
    ...
    def isKnapsack(self) -> bool: ...
    def isLinear(self) -> bool: ...
    def isLinearType(self) -> bool: ...
    def isLocal(self) -> bool: ...
    def isModifiable(self) -> bool: ...
...
class IIS:
    ...
    def getSubscip(self) -> Model: ...
    def getTime(self) -> float: ...
    def greedyMakeIrreducible(self) -> None: ...
    def isSubscipInfeasible(self) -> bool: ...
    def isSubscipIrreducible(self) -> bool: ...
    def setSubscipInfeasible(self, infeasible: bool) -> None: ...
    def setSubscipIrreducible(self, irreducible: bool) -> None: ...
...
class Model:
    ...
    def addVarLocksType(
        self, var: Variable, locktype: PY_SCIP_LOCKTYPE, nlocksdown: int, nlocksup: int
    ) -> None: ...
    ...
    def branchLPExact(self) -> PY_SCIP_RESULT: ...
    ...
    def getVarPseudocost(
        self, var: Variable, branchdir: PY_SCIP_BRANCHDIR
    ) -> float: ...
